export default {
  alert: {
    ...
    danger: 'bg-danger-50 text-danger-900 dark:bg-danger-600 dark:text-darkText',
    ...
    icon: {
      ...
      danger: 'text-danger-400 dark:text-danger-300',
  ...
  textarea: {
    ...
    invalid:
      'border-danger-600 dark:bg-neutral-700 focus:border-danger-400 dark:focus:border-danger-400 focus:ring focus:ring-danger-200 dark:focus:ring-danger-200',
  },
  select: {
